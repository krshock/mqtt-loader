...
func main() {
	...
	scanPozoTopic("2024-06-19", "2025-03-31", "51c4faf3-48d1-44bf-9791-713d172b645e")
	scanPozoTopic("2024-06-19", "2025-03-31", "625396c8-acc0-49fa-a81f-6cd7bc951575")
	scanPozoTopic("2024-06-19", "2025-03-31", "5c1b28f2-4e44-4009-8fbc-964fa7a0c957")
	scanPozoTopic("2024-06-19", "2025-03-31", "528a736b-a589-497a-9e9f-4bb5179d8ff2")
	scanPozoTopic("2024-06-19", "2025-03-31", "8d117b00-137d-499c-9d6f-42dd43004f32")
	scanPozoTopic("2024-06-19", "2025-03-31", "7267b1c8-81c9-4cfb-b6e9-ad2695cf8279")
	scanPozoTopic("2024-06-19", "2025-03-31", "ea96ae4e-9822-4da2-95b9-4c0bcbd95d32")
	scanPozoTopic("2024-06-19", "2025-03-31", "a1fa8029-7dd2-47b6-a3ae-627e24a9956a")

}

func scanPozoTopic(startdate string, endDate string, topicId string) {
	log.Printf("Topic: %v\n", topicId)
	...
	for d := start; !d.After(end); d = d.AddDate(0, 0, 1) {
		...
		nerrores, nlineas := scanPozoFile(d, topicId, &flagsMap)
...
func scanPozoFile(date time.Time, topicId string, flagsMap *map[string]int64) (int64, int64) {
